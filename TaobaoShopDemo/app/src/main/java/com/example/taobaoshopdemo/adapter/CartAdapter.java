...
import com.example.taobaoshopdemo.widget.NumberAddSubView;
...
public class CartAdapter extends SimpleAdapter<ShoppingCart> implements BaseAdapter.OnItemClickListener {
    ...
    protected void convert(BaseViewHolder viewHoder, final ShoppingCart item) {
        ...
        viewHoder.getTextView(R.id.temp_cart_tv_title).setText(item.getName());
        viewHoder.getTextView(R.id.temp_cart_tv_price).setText("￥"+item.getPrice());
        SimpleDraweeView draweeView = (SimpleDraweeView) viewHoder.getView(R.id.temp_cart_drawee_view);
        draweeView.setImageURI(Uri.parse(item.getImgUrl()));

        CheckBox checkBox = (CheckBox) viewHoder.getView(R.id.temp_cart_checkbox);
